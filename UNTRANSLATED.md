...
Каталог покрывает **10258 из 10438** строк Orca (98%).
Ниже — полный разбор оставшихся 180.
...
**669 строк** оставлены в оригинале намеренно, тождественным переводом
...
Все строки вне защищённой зоны обработаны.

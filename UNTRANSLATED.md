...
Каталог покрывает **12 105 из 12 292** строк Orca 1.4.176 (98%).
Ниже — полный разбор оставшихся 187.
...
**979 строк** оставлены в оригинале намеренно, тождественным переводом
